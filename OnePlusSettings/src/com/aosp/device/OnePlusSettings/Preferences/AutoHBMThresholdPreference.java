...
public class AutoHBMThresholdPreference extends CustomSeekBarPreference {
    ...
    public AutoHBMThresholdPreference(Context context, AttributeSet attrs) {
        ...
        mValue = Integer.parseInt(sharedPrefs.getString(OnePlusSettings.KEY_AUTO_HBM_THRESHOLD, "20000"));
    ...
    protected void changeValue(int newValue) {
        ...
        prefChange.putString(OnePlusSettings.KEY_AUTO_HBM_THRESHOLD, String.valueOf(newValue)).commit();
    }
}
