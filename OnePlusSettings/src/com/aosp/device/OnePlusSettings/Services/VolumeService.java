...
public class VolumeService {
    ...
    public static void changeMediaVolume(AudioManager mAudioManager, Context context) {
        final int currentVolume = getMediaVolume(mAudioManager);
        final int savedVolume = getSavedVolume(context);
        final int shouldChange = shouldChangeMediaVolume(isCurrentlyEnabled(context), isSpeakerOutput(context), currentVolume, savedVolume, isSilentMode(mAudioManager));
